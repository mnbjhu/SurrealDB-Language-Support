...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [197] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(78),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(82),
  ...
  [437] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2), SHIFT_REPEAT(78),
  [440] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2), SHIFT_REPEAT(82),
  ...
  [527] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_identifier, 2),
  [529] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_identifier, 2),
  [531] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_identifier, 1),
  [533] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_identifier, 1),
  [535] = {.entry = {.count = 1, .reusable = true}}, SHIFT(130),
  [537] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_identifier_repeat1, 2),
  [539] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_function_identifier_repeat1, 2),
  [541] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_identifier_repeat1, 2), SHIFT_REPEAT(153),
  [544] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 2),
  [546] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_generic_type, 4),
  [548] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type, 1),
  [550] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1),
  [552] = {.entry = {.count = 1, .reusable = false}}, SHIFT(72),
  [554] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_varargs_repeat1, 2), SHIFT_REPEAT(62),
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2),
  [559] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varargs, 2),
  [561] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function, 1),
  [563] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 1),
  [565] = {.entry = {.count = 1, .reusable = false}}, SHIFT(71),
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_arguments, 2),
  [569] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_name, 1),
  [571] = {.entry = {.count = 1, .reusable = true}}, SHIFT(142),
  [573] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field, 1),
  [575] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 1),
  [577] = {.entry = {.count = 1, .reusable = false}}, SHIFT(84),
  [579] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_arguments, 3),
  [581] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_name, 2),
  ...
  [590] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 3),
